                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="relative px-8 py-7 space-y-6">
                            ...
                            <div className="flex items-center justify-between pt-1">
                                <label className="flex items-center gap-2.5 cursor-pointer group">
                                    <div
                                        ...
                                        className={`w-4 h-4 border flex items-center justify-center transition-all cursor-pointer ${rememberMe ? 'border-amber-400/60 bg-amber-400/10' : 'border-slate-700/60 group-hover:border-slate-500/80'}`}
                                    >
                                        {rememberMe && (
                                            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="w-2 h-2 bg-amber-400/80" />
                                        )}
                                    </div>
                                    <span className="text-xs text-slate-500 group-hover:text-slate-400 transition-colors">Recordarme</span>
                                </label>
                                <button type="button" className="text-[10px] uppercase tracking-[0.15em] text-slate-600 hover:text-amber-400/70 transition-colors">
                            ...
                            <div className="pt-2 space-y-3">
                                ...
                                >
                                    {isLoading ? (
                                        <><Loader2 className="w-3.5 h-3.5 animate-spin" />Iniciando sesión…</>
                                    ) : (
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] uppercase tracking-[0.2em] text-slate-600">o continúa con</span>
                                    <div className="flex-1 h-px bg-slate-800/60" />
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        disabled={isLoading}
                                        className="flex items-center justify-center gap-2 py-2.5 border border-slate-700/60 hover:border-slate-500/80 text-slate-400 hover:text-white text-xs transition-all disabled:opacity-50"
                                    >
