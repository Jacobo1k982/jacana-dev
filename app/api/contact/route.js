  ...
  try {
    ...
    if (!token || !chat_id) {
      return NextResponse.json({
        success: false,
        message: 'Falta el token de Telegram o el ID de chat.',
      }, { status: 400 });
    }
    ...
    if (telegramSuccess && emailSuccess) {
      return NextResponse.json({
        success: true,
        message: '¡Mensaje y correo electrónico enviados exitosamente!',
      }, { status: 200 });
    }

    return NextResponse.json({
      success: false,
      message: 'Error al enviar el mensaje o correo electrónico.',
    }, { status: 500 });
  } catch (error) {
